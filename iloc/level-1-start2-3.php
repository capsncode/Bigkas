                    ...
                    <div class="container">
                        <div class="mb-3 row">
                            <div class="col col-md-3">
                                ...
                                <div class="mb-3 row">
                                    <div class="col">
                                        <a type="button" class="btn btn-warning btn-lg" style="border-color:#619CFF; border-width: 3px; border-radius: 25px; width: 250px;"href="level-1-x-solution2.php">Check</a>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="row mx-auto">
                                        <div class="col">
                                            ...
                                            <div class="row mb-3 text-center" style="font-family: 'Courier New', Courier, monospace;">
                                                <div class="col-sm-2">
                                                    <a type="button" class="btn" style="font-size: x-large;" onclick="rabii()"href="level-1-start2-1.php">
                                                        <audio id="rabii" src="../assets/Audio Files/rabii.m4a"></audio>
                                                        <strong>Rabii</strong>
                                                    </a>
                                                </div>
                                                <div class="col-sm-2">
                                                    <a type="button" class="btn" style="font-size: x-large;" onclick="maynila()"href="level-1-start2-2.php">
                                                ...
                                                <div class="col-sm-2">
                                                    <a type="button" class="btn" style="font-size: x-large;" onclick="tagaano()"href="level-1-start2-4.php">
                                                        <audio id="tagaano" src="../assets/Audio Files/tagaano.m4a"></audio>
                                                        <strong>tagaano</strong>
                                                    </a>
                                                </div>
                                                <div class="col-sm-2">
                                                    <a type="button" class="btn" style="font-size: x-large;" onclick="naimbag()"href="level-1-start2-5.php">
