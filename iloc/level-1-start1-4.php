...
<html lang="en">
    ...
    <body>
                    ...
                    <div class="container">
                        <div class="mb-3 row">
                            <div class="col col-md-3">
                                ...
                                <div class="mb-3 row">
                                    <div class="col">
                                        <a type="button" class="btn btn-warning btn-lg" style="border-color:#619CFF; border-width: 3px; border-radius: 25px; width: 250px;"href="level-1-x-solution1.php">Check</a>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="col">
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-6 text-center" style="background-image: url('../assets/Image Files/bubble.png'); background-repeat: no-repeat; background-size: contain; background-position: left; padding-top: 150px;">
                                                    <p style="font-size: xx-large; font-family: 'Courier New', Courier, monospace; line-height: 1.5rem;"><strong><br>Morning</strong></p>
                                                </div>
                                            </div>
                                            <div class="row mb-3 text-center" style="font-family: 'Courier New', Courier, monospace;">
                                                <div class="col-sm-2">
                                                    <a type="button" class="btn" style="font-size: x-large;" onclick="nagan()"href="level-1-start1-1.php">
                                                        <audio id="nagan" src="../assets/Audio Files/nagan.m4a"></audio>
                                                        <strong>nagan</strong>
                                                    </a>
                                                </div>
                                                <div class="col-sm-2">
                                                    <a type="button" class="btn" style="font-size: x-large;" onclick="naimas()"href="level-1-start1-2.php">
                                                        <audio id="naimas" src="../assets/Audio Files/naimas.mp3"></audio>
                                                        <strong>naimas</strong>
                                                    </a>
                                                </div>
                                                <div class="col-sm-2">
                                                    <a type="button" class="btn" style="font-size: x-large;" onclick="bigat()"href="level-1-start1-3.php">
                                                        <audio id="bigat" src="../assets/Audio Files/bigat.m4a"></audio>
                                                        <strong>bigat</strong>
                                                    </a>
                                                </div>
                                                <div class="col-sm-2">
                                                    <a type="button" class="btn" style="border-color:#619CFF; border-width:3px; font-size: x-large;" onclick="nga()">
                                                        <audio id="nga" src="../assets/Audio Files/nga.m4a"></audio>
                                                        <strong>nga</strong></a>
                                                </div>
                                                <div class="col-sm-2">
                                                    <a type="button" class="btn" style="font-size: x-large;" onclick="naimbag()"href="level-1-start1-5.php">
        ...
        <!-- Other -->
        <script>
            let nagan = function(){document.getElementById("nagan").play()}
            let naimas = function(){document.getElementById("naimas").play()}
            let bigat = function(){document.getElementById("bigat").play()}
            let nga = function(){document.getElementById("nga").play()}
