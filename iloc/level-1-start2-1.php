                    ...
                    <div class="container">
                        <div class="mb-3 row">
                            <div class="col col-md-3">
                                ...
                                <div class="mb-3 row">
                                    <div class="col">
                                        <a type="button" class="btn btn-warning btn-lg" style="border-color:#619CFF; border-width: 3px; border-radius: 25px; width: 250px;" href="level-1-solution2.php">Check</a>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="row mx-auto">
                                        <div class="col">
                                            ...
                                            <div class="row mb-3 text-center" style="font-family: 'Courier New', Courier, monospace;">
                                                <div class="col-sm-2">
                                                    <a type="button" class="btn" style="border-color:#619CFF; border-width:3px; font-size: x-large;" onclick="rabii()">
