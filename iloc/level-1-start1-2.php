                                    ...
                                    <div class="row mx-auto">
                                        <div class="col">
                                            ...
                                            <div class="row mb-3 text-center" style="font-family: 'Courier New', Courier, monospace;">
                                                ...
                                                <div class="col-sm-2">
                                                    <a type="button" class="btn" style="border-color:#619CFF; border-width:3px; font-size: x-large;" onclick="naimas()">
                                                ...
                                                <div class="col-sm-2">
                                                    <a type="button" class="btn" style="font-size: x-large;" onclick="nga()"href="level-1-start1-4.php">
