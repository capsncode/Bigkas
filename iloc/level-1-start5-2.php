...
<html lang="en">
    ...
    <body>
                    ...
                    <div class="container">
                        <div class="mb-3 row">
                            <div class="col col-md-3">
                                ...
                                <div class="mb-3 row">
                                    <div class="col">
                                        <a type="button" class="btn btn-warning btn-lg" style="border-color:#619CFF; border-width: 3px; border-radius: 25px; width: 250px;"href="level-1-x-solution5.php">Check</a>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="col">
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-6 text-center" style="background-image: url('../assets/Image Files/bubble.png'); background-repeat: no-repeat; background-size: contain; background-position: left; padding-top: 150px;">
                                                    <p style="font-size: xx-large; font-family: 'Courier New', Courier, monospace; line-height: 1.5rem;"><strong><br>Evening</strong></p>
                                                </div>
                                            </div>
                                            <div class="row mb-3 text-center" style="font-family: 'Courier New', Courier, monospace;">
                                                <div class="col-sm-2">
                                                    <a type="button" class="btn" style="font-size: x-large;" onclick="rabii()"href="level-1-start5-1.php">
                                                        <audio id="rabii" src="../assets/Audio Files/rabii.m4a"></audio>
                                                        <strong>Rabii</strong>
                                                    </a>
                                                </div>
                                                <div class="col-sm-2">
                                                    <a type="button" class="btn" style="border-color:#619CFF; border-width:3px;font-size: x-large;" onclick="maynila()">
                                                        <audio id="maynila" src="../assets/Audio Files/maynila.mp3"></audio>
                                                        <strong>Maynila</strong>
                                                    </a>
                                                </div>
                                                <div class="col-sm-2">
                                                    <a type="button" class="btn" style="font-size: x-large;" onclick="bigat()"href="level-1-start5-3.php">
                                                        <audio id="bigat" src="../assets/Audio Files/bigat.m4a"></audio>
                                                        <strong>Bigat</strong>
                                                    </a>
                                                </div>
                                                <div class="col-sm-2">
                                                    <a type="button" class="btn" style="font-size: x-large;" onclick="tagaano()"href="level-1-start5-4.php">
                                                        <audio id="tagaano" src="../assets/Audio Files/tagaano.m4a"></audio>
                                                        <strong>tagaano</strong>
                                                    </a>
                                                </div>
                                                <div class="col-sm-2">
                                                    <a type="button" class="btn" style="font-size: x-large;" onclick="naimbag()"href="level-1-start5-5.php">
        ...
        <script>
            ...
            let maynila = function(){document.getElementById("maynila").play()}
            let bigat = function(){document.getElementById("bigat").play()}
            let tagaano = function(){document.getElementById("tagaano").play()}
